...
export const OrderButton = () => {
  ...
  const countPizzas = useTypedSelector(({ mainPage }) => mainPage.count);
  return (
    <div className='orderButton' onClick={() => dispatch(openOrderPage())}>
      <div>
        {isActive ? (
          <div className='orderButton__container'>вернуться к пиццам</div>
        ) : (
          <div className='orderButton__container'>
            <div className='orderButton__orders'>
              <div className='orderButton__bracket'>
                <svg
